...
public class Tacauto extends Taco_Super_class {
    ...
    public void runOpMode() {
        ...
        while (Rounds < 16 && opModeIsActive()) {
        ...
        while (nextstep(1000,0,0)&& opModeIsActive()){
            teledrive(foregoal(1000),rightgoal(0),turngoal(0));
            drivetele();
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
        sleep(250);
        while (Zone == 1 && opModeIsActive()) {
            Zone_A();
        }
        while (Zone == 2 && opModeIsActive()) {
            Zone_B();
        }
        while (Zone == 3 && opModeIsActive()) {
            Zone_C();
        }
    ...
    public void Zone_B() {
       ...
       /* Right_Front.setTargetPosition(1225);
        ...
        Run_To_Position();
        Motor_Power();*/
        while (nextstep(1150,0,0)){
            teledrive(foregoal(1150),rightgoal(0),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
        ...
        while (nextstep(-700,0,0)){
            teledrive(foregoal(-700),rightgoal(0),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
      ...
      //  driveleft(800,.8);
       ...
       // driveBackwardEncoders(1600,.33);
        while (nextstep(-1600,0,0)){
            teledrive(foregoal(-1600),rightgoal(0),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
    ...
    public void Zone_C() {
       ...
       // driveForwardEncoders(2800,.8);
        while (nextstep(2800,0,0)){
            teledrive(foregoal(2800),rightgoal(0),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
        ...
        sleep(3000);
       // driveleft(100,.8);
        while (nextstep(0,-100,0)){
            teledrive(foregoal(0),rightgoal(-100),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
        sleep(1000);
        ...
        sleep(2000);
        driveleft(1500,.8);
        while (nextstep(0,-2000,0)){
            teledrive(foregoal(0),rightgoal(-2000),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
       ...
       //driveBackwardEncoders(300,.8);
        while (nextstep(-300,0,0)){
            teledrive(foregoal(-300),rightgoal(0),turngoal(0));
        }
        teledrive(0,0,0);
        Stop_And_Reset_Encoders();
